...
export default function Homebutton(){
    ...
    <button onClick={()=>{router.push('/signup')}} className=" lg:hidden bg-olive-900 text-white p-2 rounded-lg fixed right-3 top-14 shadow-lg hover:bg-green-300 hover:scale-105 hover:text-black transition duration-300  sm:w-36" > Signup </button>
    </div>
}